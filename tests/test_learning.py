...
class TestThermalLearning:
    ...
    def test_optimal_limit_timeout_uses_observed_response_directly(self):
        """Test that optimal_limit_timeout uses observed response time directly."""
        learning = ThermalLearning()
        ...
        # With median=4, optimal should be 4 (no min cap applied)
        assert optimal["limit_timeout"] == 4
